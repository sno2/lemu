...
pub const Instruction = packed union {
    ...
    pub const Codec = struct {
        ...
        pub const list = std.enums.directEnumArray(Tag, Codec, 0, .{
            ...
            .blt = .init(.blt, .{ .cb = .{ .op = 2 } }, .init(0x2A0, 0x2A7), false, &.{ "B.LT", "BLT" }, "Branch if Less Than"),
            .ble = .init(.ble, .{ .cb = .{ .op = 3 } }, .init(0x2A0, 0x2A7), false, &.{ "B.LE", "BLE" }, "Branch if Less Than or Equal"),
            .bgt = .init(.bgt, .{ .cb = .{ .op = 4 } }, .init(0x2A0, 0x2A7), false, &.{ "B.GT", "BGT" }, "Branch if Greater Than"),
            .bge = .init(.bge, .{ .cb = .{ .op = 5 } }, .init(0x2A0, 0x2A7), false, &.{ "B.GE", "BGE" }, "Branch if Greater Than or Equal"),
            .blo = .init(.blo, .{ .cb = .{ .op = 6 } }, .init(0x2A0, 0x2A7), false, &.{ "B.LO", "BLO" }, "Branch if Less Than (Unsigned)"),
            .bls = .init(.bls, .{ .cb = .{ .op = 7 } }, .init(0x2A0, 0x2A7), false, &.{ "B.LS", "BLS" }, "Branch if Less Than or Equal (Unsigned)"),
            .bhi = .init(.bhi, .{ .cb = .{ .op = 8 } }, .init(0x2A0, 0x2A7), false, &.{ "B.HI", "BHI" }, "Branch if Greater Than (Unsigned)"),
            .bhs = .init(.bhs, .{ .cb = .{ .op = 9 } }, .init(0x2A0, 0x2A7), false, &.{ "B.HS", "BHS" }, "Branch if Greater Than or Equal (Unsigned)"),
            .bmi = .init(.bmi, .{ .cb = .{ .op = 10 } }, .init(0x2A0, 0x2A7), false, &.{ "B.MI", "BMI" }, "Branch if Minus"),
            .bpl = .init(.bpl, .{ .cb = .{ .op = 11 } }, .init(0x2A0, 0x2A7), false, &.{ "B.PL", "BPL" }, "Branch if Plus"),
            .bvs = .init(.bvs, .{ .cb = .{ .op = 12 } }, .init(0x2A0, 0x2A7), false, &.{ "B.VS", "BVS" }, "Branch if Overflow Set"),
            .bvc = .init(.bvc, .{ .cb = .{ .op = 13 } }, .init(0x2A0, 0x2A7), false, &.{ "B.VC", "BVC" }, "Branch if Overflow Clear"),
            ...
            .ldurs = .init(.ldurs, .{ .d = .{} }, .initSingle(0x5E2), false, &.{"LDURS"}, "LoaD Single floating-point"),
            .ldurd = .init(.ldurd, .{ .d = .{} }, .initSingle(0x7E2), false, &.{"LDURD"}, "LoaD Double floating-point"),
            ...
            .sturs = .init(.sturs, .{ .d = .{} }, .initSingle(0x5E0), false, &.{"STURS"}, "STore Single floating-point"),
            .sturd = .init(.sturd, .{ .d = .{} }, .initSingle(0x7E0), false, &.{"STURD"}, "STore Double floating-point"),
            ...
            .prnt = .init(.prnt, .{ .r = .{ .shamt = null, .style = .Xn } }, .initSingle(0x7FD), false, &.{"PRNT"}, "PRiNT register (non-standard)"),
